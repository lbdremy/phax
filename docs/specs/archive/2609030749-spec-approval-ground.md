...
**normative**)

    {
      "version": 1,
      "records": {
        "docs/specs/2609030725-provider-contract-discoverability.md": {
...
**normative**; layout indicative)
    ...
    $ phax artifact approve docs/specs/2609030725-provider-contract-discoverability.md
    Status: Approved
    Baseline: c924ed8
...
**normative** in presence; wording indicative)
    ...
    Path:              docs/specs/2609030725-provider-contract-discoverability.md
    Kind:              spec
    Status:            Approved
...
**normative**; wording indicative)
    ...
    ✗ approve refused: docs/specs/2607031249-gate-step-scheduling.md is Approved but edited since its
      approval (7b64e98) — re-approve the spec first
    $? = 12

    ✗ approve refused: docs/specs/2607031249-gate-step-scheduling.md is Approved but its approval is
