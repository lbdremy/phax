...
phax artifact archive docs/specs/2608091526-artifact-lifecycle-status.md      # also moves the file to archive/
phax artifact abandon docs/plans/2607101056-typescript-7-migration-plan.md    # dropped without execution; also moves to archive/
