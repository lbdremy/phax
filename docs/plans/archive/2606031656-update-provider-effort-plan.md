---
status: Completed
source-spec: docs/specs/archive/2606031656-update-provider-effort.md
---
# Implementation plan — Provider-specific effort/thinking enums and routing corrections

> Run short name: `update-provider-effort`.
> Deliverable location: `docs/plans/2606031656-update-provider-effort-plan.md`.
...
> `docs/plans/2606031656-provider-e2e-validation-plan.md` and is run **manually**, not via
...
This plan implements `docs/specs/2606031656-update-provider-effort.md`. Four workstreams:
...
`docs/plans/2606031656-provider-e2e-validation-plan.md`.
