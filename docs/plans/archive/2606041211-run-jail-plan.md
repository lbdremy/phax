---
status: Completed
source-spec: docs/specs/archive/2606041211-run-jail.md
---
# Implementation plan — Provider-native security mode (run jail)

> Run short name: `run-jail`.
> Deliverable location: `docs/plans/2606041211-run-jail-plan.md`.
...
> `docs/plans/2606041211-run-jail-provider-validation-plan.md` and is run **manually**, not
...
This plan implements `docs/specs/2606041211-run-jail.md`: make PHAX safe by default by
