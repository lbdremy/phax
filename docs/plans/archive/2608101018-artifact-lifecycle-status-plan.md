---
status: Completed
source-spec: docs/specs/2608091526-artifact-lifecycle-status.md
---
# Artifact lifecycle status

> Feed this `plan.md` to `phax extract-plan` to produce `phax-plan.json`, then
> run it with `phax run`. Source spec:
> [`docs/specs/2608091526-artifact-lifecycle-status.md`](../specs/2608091526-artifact-lifecycle-status.md).
...
- **Status line grammar:** the first line matching `Status: <value>` in the header
  ...
  illustrative `Status:` block inside `docs/specs/2608091526-plan-staleness-lineage.md` §6 inert.
...
- Insertion rule everywhere: the `Status: <value>` line goes in the header region
  ...
  `docs/specs/2608091526-plan-staleness-lineage.md` §6) or inside code fences.
- Every **plan** file touched (live and archived; specs never carry one) also gains a
  ...
  mappings for the live plans: 17 → `docs/specs/archive/2607031249-brief-profile-orient.md`,
  44 → `docs/specs/2607031249-gate-profile-attributed-steps.md`; 45 states "No source spec" →
...
- Do not touch `docs/plans/2608101018-artifact-lifecycle-status-plan.md` (this plan — it already
...
- docs/plans/2607101034-gate-profile-attributed-steps-plan.md
- docs/plans/2607101056-typescript-7-migration-plan.md
- docs/plans/2607221702-brief-profile-orient-plan.md
- docs/plans/2606261007-plans-overlap-command-plan.md
- docs/plans/2606261047-plan-extraction-cache-plan.md
- docs/plans/2606291222-deterministic-plan-extraction-plan.md
- docs/plans/2606301550-review-compliance-qualified-name-plan.md
- docs/plans/2607020808-security-hardening-plan.md
