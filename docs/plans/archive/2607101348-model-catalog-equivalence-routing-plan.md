---
status: Completed
source-spec: docs/specs/archive/2607101341-model-catalog-equivalence-routing.md
---
# Model catalog and equivalence routing

This plan implements spec `docs/specs/2607101341-model-catalog-equivalence-routing.md`
