---
status: Completed
source-spec: docs/specs/2608110950-artifact-frontmatter-metadata.md
approved:
  date: 2026-08-12
  baseline: db318d1
---
...
(`docs/plans/2608121433-artifact-frontmatter-metadata-plan.md`) is one of the artifacts being
...
- `src/domain/artifact/document.ts`: delete `readStatusLine` and `replaceStatusLine`
  ...
  - `missing-block` → `<path> has no frontmatter block — lifecycle metadata must be YAML
    frontmatter (see docs/specs/2608110950-artifact-frontmatter-metadata.md)`
...
- `docs/specs/2607031249-gate-profile-attributed-steps.md`
- `docs/specs/2607031249-external-gate-steps.md`
- `docs/specs/2607031249-gate-step-scheduling.md`
- `docs/specs/2607031249-plan-completeness-advisory.md`
- `docs/specs/2608091526-phase-decision-requests.md`
- `docs/specs/2608091526-batch-execution-disjoint-plans.md`
- `docs/specs/2608110950-artifact-frontmatter-metadata.md`
- `docs/specs/2608121241-run-carries-archival.md`
- `docs/specs/2608121241-rename-archived-to-completed.md`
...
- `docs/plans/2608121433-artifact-frontmatter-metadata-plan.md`
