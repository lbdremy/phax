...
> `docs/plans/2606031656-update-provider-effort-plan.md` (phases 03 and 04) against the
> real provider CLIs.
>
> The spec (`docs/specs/2606031656-update-provider-effort.md`) is explicit: the goal is
